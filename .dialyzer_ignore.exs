[
  ...
  # forms work correctly. Mirrors the same ignore in phoenix_kit_catalogue /
  # phoenix_kit_projects, which carry their own Gettext backends too.
  {"lib/phoenix_kit_staff/gettext.ex", :call_without_opaque}
]
