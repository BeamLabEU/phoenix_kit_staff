defmodule PhoenixKitStaff.ActivityLogAssertions do
  @moduledoc """
  Helpers for asserting activity log entries landed with the right
  action, module, and metadata shape.

  Imported into `PhoenixKitStaff.DataCase` and
  `PhoenixKitStaff.LiveCase` so every DB-backed test can reach them.
  """
